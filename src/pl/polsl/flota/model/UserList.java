...
public class UserList {
	...
	/**
	 * Add a user to a list of objects. If element with the same id exists
	 * throws an ElementAlredyExists Exception.
	 * 
	 * @param user
	 *            a User object to add @see User
