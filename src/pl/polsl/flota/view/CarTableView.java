...
public class CarTableView extends AbstractTableModel {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case 0:
                returnVal = currentCar.getRegNumber();
                break;
            case 1:
                returnVal = currentCar.getName();
                break;
            case 2:
                returnVal = currentCar.getDistance();
                break;
            case 3:
                returnVal = currentCar.getAcctualDriverId();
                break;
            case 4:
                returnVal = currentCar.getAvgConsumpion();
                break;
        }
        return returnVal;
    }
    ...
    public void setValueAt(Object value, int row, int col) {
        ...
        switch (col) {
            case 0:
                break; //Change of reg number is not permitted to edit.
            case 1:
                carName = (String) value;
                break;
            case 2:
                userDistance = (Integer) value;
                break;
            case 3:
                break; //Change of driver id is not permitted.
            case 4:
                consumpition = (Float) value;
                break;
        }
    ...
    public void deleteItem(int selectedRow) {
        ...
        try {
            ...
            Logger.getLogger(CarTableView.class.getName()).log(Level.SEVERE, null, ex);
        }
