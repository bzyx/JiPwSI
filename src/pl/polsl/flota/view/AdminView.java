...
public class AdminView {
    ...
    public void addCar() throws ElementAlredyExists {
        ...
        try {
            ...
            System.out.println("AdminView addCar should be an Integer. Look at TODO");
        }
        ...
        try {
            ...
            System.out.println("AdminView addCar should be an Float. Look at TODO");
        }
    ...
    public void deleteCar() throws ElementNotFound {
        Helpers.clearScren();
        System.out.println("Podaj numer rejestracyjny samochodu lub jego nazwę: ?");
    ...
    public void editOrViewCar() throws ElementNotFound {
        ...
        if (carParams.size() > 3) {
            ...
            System.out.println("Data:          Przebieg: 		Ilość paliwa:		Wartość:");
