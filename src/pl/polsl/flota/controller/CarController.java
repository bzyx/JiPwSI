...
public class CarController {
     ...
     * @throws IOException thrown from load
     */
    ...
    public void addCar(String userRegNumber, String userCarName,
        ...
        Car car = new Car.CarBuilder(userRegNumber, userCarName).distance(userDistanceInt).consumption(userConsumpitonFloat).build();
        carList.addItem(car);
